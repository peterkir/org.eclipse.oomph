...
public interface WorkspaceTask extends SetupTask
{
   ...
   *        annotation="http://www.eclipse.org/oomph/setup/RuleVariable name='workspace.container.root' type='FOLDER' label='Root workspace-container folder' defaultValue='${oomph.home}' description='The root workspace-container folder where all the workspaces are located' storageURI='scope://'"
